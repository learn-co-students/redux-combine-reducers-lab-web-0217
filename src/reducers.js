...
//The 'combineReducers' above is essentially the code below.  it takes all reducers and
//takes each key to flow through the tree.  Honestly, i don't understand it, but it's now one nice line.
